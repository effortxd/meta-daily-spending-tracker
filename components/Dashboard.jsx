...
<style>{`@import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Manrope:wght@400;500;600;700;800&display=swap'); .font-display { font-family: 'Manrope', ui-sans-serif, system-ui, sans-serif; letter-spacing: -0.02em; } .font-mono-num { font-family: 'JetBrains Mono', ui-monospace, monospace; font-variant-numeric: tabular-nums; } .glass { background: rgba(15, 23, 42, 0.55); backdrop-filter: blur(12px); border: 1px solid rgba(148,163,184,0.10); } .glass-hover:hover { border-color: rgba(148,163,184,0.22); } input, select, textarea { color-scheme: dark; } ::placeholder { color: rgb(100 116 139); } @keyframes pulse-dot { 0%, 100% { opacity: 1; } 50% { opacity: 0.4; } } .pulse-dot { animation: pulse-dot 2s ease-in-out infinite; } .scroll-x::-webkit-scrollbar { height: 6px; } .scroll-x::-webkit-scrollbar-thumb { background: rgba(148,163,184,0.2); border-radius: 3px; } .input-base { width: 100%; padding: 0.625rem 0.75rem; border-radius: 0.5rem; background: rgba(15, 23, 42, 0.6); border: 1px solid rgba(51, 65, 85, 0.5); color: rgb(241, 245, 249); font-size: 0.875rem; outline: none; transition: all 0.15s; } .input-base:focus { border-color: rgba(34, 211, 238, 0.5); box-shadow: 0 0 0 1px rgba(34, 211, 238, 0.3); }`}</style>
